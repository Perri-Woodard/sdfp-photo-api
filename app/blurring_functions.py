...
def blurCB_01(path):
    ...
    top_left_y1 = int(image.shape[0] * .10)  

    #Bottom coordinates
    bottom_left_x2 = int(image.shape[1] * .32)
    bottom_left_y2 = int(image.shape[0] * .44)  # Adjust the fraction as needed
    ...
    top_left2_y1 = int(image.shape[0] * .10)  

    #Bottom coordinates
    bottom_left2_x2 = int(image.shape[1] * .40)
    bottom_left2_y2 = int(image.shape[0] * .44)  # Adjust the fraction as needed
    ...
    bottom_left3_y2 = int(image.shape[0] * .40)
    ...
    top_rmid_y1 = int(image.shape[0] * .28)  

    #Bottom coordinates
    bottom_rmid_x2 = int(image.shape[1] * 1)
    bottom_rmid_y2 = int(image.shape[0] * .46)  # Adjust the fraction as needed
    ...
    top_rmid2_y1 = int(image.shape[0] * .30)  

    #Bottom coordinates
    bottom_rmid2_x2 = int(image.shape[1] * .68)
    bottom_rmid2_y2 = int(image.shape[0] * .42)  # Adjust the fraction as needed
...
def blurCB_01B(path):
    ...
    top_mid_y1 = int(image.shape[0] * .19)  

    #Bottom coordinates
    bottom_mid_x2 = int(image.shape[1] * .76)
    bottom_mid_y2 = int(image.shape[0] * .33)  # Adjust the fraction as needed
    ...
    top_mid2_y1 = int(image.shape[0] * .19)  

    #Bottom coordinates
    bottom_mid2_x2 = int(image.shape[1] * .47)
    bottom_mid2_y2 = int(image.shape[0] * .32)  # Adjust the fraction as needed
    ...
    top_rmid_y1 = int(image.shape[0] * .10)  

    #Bottom coordinates
    bottom_rmid_x2 = int(image.shape[1] * 1)
    bottom_rmid_y2 = int(image.shape[0] * .35)  # Adjust the fraction as needed
...
def blurCB_02(path):
    ...
    # Top coordinates
    top_left_x1 = int(image.shape[1] * .00)  # Adjust the fraction as needed
    top_left_y1 = int(image.shape[0] * .06)  

    #Bottom coordinates
    bottom_left_x2 = int(image.shape[1] * .25)
    bottom_left_y2 = int(image.shape[0] * .245)  # Adjust the fraction as needed
    ...
    top_mid_y1 = int(image.shape[0] * .03)  
    ...
    top_mid2_y1 = int(image.shape[0] * .03)  

    #Bottom coordinates
    bottom_mid2_x2 = int(image.shape[1] * .52)
    bottom_mid2_y2 = int(image.shape[0] * .26)  # Adjust the fraction as needed
    ...
    top_mid3_y1 = int(image.shape[0] * .02)  

    #Bottom coordinates
    bottom_mid3_x2 = int(image.shape[1] * .45)
    bottom_mid3_y2 = int(image.shape[0] * .215)  # Adjust the fraction as needed
    ...
    top_rmid_y1 = int(image.shape[0] * 0)  

    #Bottom coordinates
    bottom_rmid_x2 = int(image.shape[1] * 1)
    bottom_rmid_y2 = int(image.shape[0] * .355)  # Adjust the fraction as needed
    ...
    bottom_rmid2_y2 = int(image.shape[0] * .35)  # Adjust the fraction as needed
...
def blurCB_03(path):
    ...
    bottom_left_y2 = int(image.shape[0] * .30)  # Adjust the fraction as needed
    ...
    bottom_left2_y2 = int(image.shape[0] * .24)  # Adjust the fraction as needed
    ...
    bottom_mid_y2 = int(image.shape[0] * .18)  # Adjust the fraction as needed
...
def blurDE_01(path):
    ...
    top_left_y = int(image.shape[0] * .33)  # Adjust the fraction as needed
...
def blurDE_03(path):
    ...
    bottom_right_y = int(image.shape[0] * .50)  # Adjust the fraction as needed
    ...
    top_left2_y = int(image.shape[0] * .41)  # Adjust the fraction as needed

    # Bottom coordinates
    bottom_right2_x = int(image.shape[1] * .28)
    bottom_right2_y = int(image.shape[0] * .46)  # Adjust the fraction as needed
    ...
    top_mid1_y = int(image.shape[0] * .27)  # Adjust the fraction as needed

    # Bottom coordinates
    bottom_mid1_x = int(image.shape[1] * .57)
    bottom_mid1_y = int(image.shape[0] * .37)  # Adjust the fraction as needed
    ...
    top_right3_y = int(image.shape[0] * .27)  # Adjust the fraction as needed

    # Bottom coordinates
    bottom_right3_x = int(image.shape[1] * 1)
    bottom_right3_y = int(image.shape[0] * .39) 
    ...
    top_right_mid_y = int(image.shape[0] * .46)  # Adjust the fraction as needed
...
def blurNB_02(path):
    ...
    top_mid1_y = int(image.shape[0] * .20)  # Adjust the fraction as needed

    # Bottom coordinates
    bottom_mid1_x = int(image.shape[1] * .52)
    bottom_mid1_y = int(image.shape[0] * .36)  # Adjust the fraction as needed
    ...
    top_right3_y = int(image.shape[0] * 0)  # Adjust the fraction as needed

    # Bottom coordinates
    bottom_right3_x = int(image.shape[1] * 1)
    bottom_right3_y = int(image.shape[0] * .32) 
    ...
    bottom_right_y = int(image.shape[0] * .26) 
